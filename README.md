...
Текст123. Ниже билд статус, пока нам это не надо, но можете потом попробовать.
...
Открыв файл через редактор можно посмотреть каким макаром вообще работает этот файл. Считайте это микрогайдом.
